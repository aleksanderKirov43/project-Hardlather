...
<?php include('../include/menu.php') ?>
    ...
    <section class="container">
        <div class="page justify__content__center row">
            <div class="col-6">
                <img class="page__img " src="../img/Hit buy/hit6.jpg">

                <img class="img__plus" src="../img/bags/bags green camuflage/bgc1.jpg">
                <img class="img__plus" src="../img/bags/bags green camuflage/bgc2.jpg">
                <img class="img__plus" src="../img/bags/bags green camuflage/bgc3.jpg">
                <img class="img__plus" src="../img/bags/bags green camuflage/bgc4.jpg">
            </div>

            <div class="col-4">
                <h1 class="page__title">Сумка бананка"Камуфляж"</h1>
                ...
                <button class="hit__button"> Добавить в корзину </button>
    </section>
