...
<div id='6' class="itemId page justify__content__center row">
                <div class="col-6">
                    <img onclick="imageZoom('ImgClick')" id="ImgClick" class="page__img" src="../img/Remni/<?= $resArticle['img'] ?>">

                    <img onclick="imageZoom('ImgClickbk1')" id="ImgClickbk1" class="img__plus" src="../img/Remni/belt vechnost/bv1.jpg">
                    <img onclick="imageZoom('ImgClickbk2')" id="ImgClickbk2" class="img__plus" src="../img/Remni/belt vechnost/bv2.jpg">
                    <img onclick="imageZoom('ImgClickbk3')" id="ImgClickbk3" class="img__plus" src="../img/Remni/belt vechnost/bv3.jpg">
                    <img onclick="imageZoom('ImgClickbk4')" id="ImgClickbk4" class="img__plus" src="../img/Remni/belt vechnost/bv4.jpg">
                </div>
